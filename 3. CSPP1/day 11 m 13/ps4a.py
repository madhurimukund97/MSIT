...
import string
#import ast
#raw_input = input('Some data: ')
#myvar = ast.literal_eval(raw_input)
...
def playGame(wordList):
    ...
    hand = ''
    while True:
        hand_choice = input('Enter n for new hand, r to replay the last hand, or e to end game: ')
        if hand_choice == 'n':
            hand = dealHand(HAND_SIZE)
            playHand(hand, wordList, HAND_SIZE)
        elif hand_choice == 'r':
            if hand == '':
                print("Play a new hand first!"+'\n')
                continue
            playHand(hand, wordList, HAND_SIZE)
        elif hand_choice == 'e':
            break
